...
object SmaliPatcher {
    ...
    fun apply(
        ...
        return try {
            ...
            // (required for install on Android 11+ / targetSdk 30). Using the
            // default ZipOutputStream would compress resources.arsc and cause the
            // "requires the resources.arsc ... aligned on a 4-byte boundary" error.
